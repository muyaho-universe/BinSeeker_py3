...
if config.STEP1_GEN_IDB_FILE:  # False
    print("step1. convert to idb file")
    subprocess.call([sys.executable, config.CODE_DIR + os.sep + "1_gen_idb_file.py"])
...
if config.STEP6_GEN_SEARCH_VULSEEKER_TFRECORD:
    subprocess.call([sys.executable, config.CODE_DIR + os.sep + "6_gen_search_tfrecord_vulseeker.py"])
