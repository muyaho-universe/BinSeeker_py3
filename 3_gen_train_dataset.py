...
print("func_list_file:", func_list_file)
...
for k, v in index_uuid.items():
    if not os.path.exists(config.FEA_DIR + os.sep + str(program) + os.sep + v + "/functions_list.csv"):
        # print("not exists:", config.FEA_DIR + os.sep + str(program) + os.sep + v + "/functions_list.csv")
        continue
...
print("func_list_dict:", func_list_dict)
time.sleep(10)

# print("func_list_train:", len(func_list_train))
print("train_dataset_num: ", train_dataset_num)
print(f"pos_num: {pos_num}, neg_num: {neg_num}")    # pos_num: 1, neg_num: 1
...
while count < train_dataset_num:
    ...
    # Generate negative example
        ...
        print("selected_list1[1]:", selected_list1[1])
    print(f"cur_num: {cur_num}, count: {count}")
